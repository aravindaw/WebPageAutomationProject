...
/**
 * TEST CASE : OPS_TC_02_NewSubscriberCreationFloor2GbpsFibreBroadband
 * DESCRIPTION : Check new user creation floor
 * SOFT DEPENDENCY : N/A
 * HARD DEPENDENCY : N/A
 */

public class OPS_TC_02_NewSubscriberCreationFloor2GbpsFibreBroadband extends ExtentTestNGITestListener{
    @Step("Step 1 : Create new subscriber")
    @Test
    public void selectPlan() {
        logger = extent.createTest(this.getClass().getName(), "Test Plan " + DataPlans.FiberBundle_2GB.getPlan());
        ...
        context.setDataPlan(DataPlans.FiberBundle_2GB.getPlan());
